...
a = Analysis(['server.py'],
             pathex=['C:\\Users\\tillr\\Documents\\Programmierung\\git_tracked\\Taskmaster_webbased\\sources\\backend'],
             binaries=[],
             datas=[],
...
'uvicorn.logging','websockets.legacy', 'websockets.legacy.server'],
             hookspath=[],
             hooksconfig={},
             runtime_hooks=[],
             excludes=[],
